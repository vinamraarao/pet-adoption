...
// Create an orange theme (same as Service Manager)
...
const ShopOwnerLayout = () => {
  ...
  const isDashboard = location.pathname === "/shop-owner/dashboard";
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      {/* Main Content */}
      <Outlet /> {/* Renders the child routes (Dashboard or ManageShopRequests) */}
      ...
      >
        <Typography variant="body2">
          © {new Date().getFullYear()} Pet Shop Owner. All rights reserved.
        </Typography>
      </Box>
    </ThemeProvider>
  );
